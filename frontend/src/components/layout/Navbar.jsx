...
const Navbar = () => {
  ...
  return (
    <header className="h-20 bg-white border-b border-transparent flex items-center justify-between px-4 sm:px-8 sticky top-0 z-30 dark:bg-slate-800 dark:border-slate-700 transition-colors duration-300">
                ...
                {isLoading ? (
                  ...
                  <div className="max-h-64 overflow-y-auto custom-scrollbar">
                    {searchResults.map(patient => (
                      ...
                      >
                        <div className="w-8 h-8 rounded-full bg-rose-50 dark:bg-rose-900/30 flex items-center justify-center text-rose-600 font-bold text-[11px]">
