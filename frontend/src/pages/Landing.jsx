...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-bg font-sans text-[#2d2a26] overflow-x-hidden selection:bg-brand-light selection:text-brand-primary">
      ...
      <section className="relative pt-20 pb-32 px-8 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          <p className="text-lg text-slate-600 mb-10 max-w-lg leading-relaxed">
            Platform modern untuk monitoring penyakit tidak menular (PTM) dan
            rekam medis pasien di tingkat desa. Menciptakan lingkungan yang
        ...
        >
          ...
          <div className="bg-white p-6 rounded-[2rem] shadow-2xl relative z-10 border border-brand-light">
            <div className="flex justify-between items-center mb-8 border-b border-slate-100 pb-4">
              ...
              <div className="text-[10px] font-bold tracking-widest text-brand-primary uppercase bg-brand-light px-3 py-1 rounded-full">
                Pratinjau
              </div>
            </div>
              ...
              <div className="h-24 bg-brand-bg rounded-2xl p-4 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-3xl font-serif text-brand-primary">
                    {stats?.ptmCases?.hypertension !== undefined
                      ? stats.ptmCases.hypertension
                      : "..."}
                  </div>
                </div>
      ...
      <section id="tentang" className="py-24 bg-white px-8">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1">
            <h2 className="text-[12px] font-bold uppercase tracking-[0.2em] text-brand-primary mb-4">
              Tentang Sistem
            </h2>
          ...
          <div className="flex-1">
            <p className="text-slate-600 leading-relaxed mb-6">
              Di SI-WARAS, kami berdedikasi untuk merancang sistem pemantauan
              kesehatan desa yang terpadu. Kami percaya bahwa pencegahan PTM
              (Penyakit Tidak Menular) dimulai dari pencatatan yang rapi,
              pemantauan aktif, dan integrasi data antara pasien dan petugas
              kesehatan.
            </p>
            <p className="text-slate-600 leading-relaxed">
              Sistem ini dirancang khusus untuk memfasilitasi kebutuhan desa
              dengan antarmuka yang elegan, mudah digunakan, dan dapat diakses
      ...
      <section
        id="fitur"
        className="py-32 bg-brand-primary text-brand-light px-8 relative overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-[12px] font-bold uppercase tracking-[0.2em] text-brand-light mb-4">
              Fitur Utama
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: HeartPulse,
                title: "Monitoring PTM",
                desc: "Pemantauan berkala pasien Hipertensi, Diabetes, dan Kolesterol.",
              },
              {
                icon: LineChart,
                title: "Grafik Kesehatan",
                desc: "Visualisasi pertumbuhan pasien dan distribusi penyakit wilayah.",
              },
              {
                icon: FileText,
                title: "Riwayat Pasien",
                desc: "Penyimpanan digital rekam medis terpusat dan aman.",
              },
              {
                icon: Activity,
                title: "Dashboard Statistik",
                desc: "Ringkasan data realtime untuk pengambilan keputusan.",
              },
              {
                icon: Users,
                title: "Multi-Role System",
                desc: "Akses khusus untuk Admin, Petugas, dan Kepala Desa.",
              },
              {
                icon: ShieldCheck,
                title: "Privasi Terjamin",
                desc: "Keamanan data setara standar fasilitas pelayanan kesehatan.",
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="bg-white/10 p-8 rounded-[2rem] border border-white/10 hover:bg-white/20 transition-all duration-300 backdrop-blur-sm"
              >
            ...
            },
            {
              value:
                stats?.ptmCases?.hypertension !== undefined
                  ? stats.ptmCases.hypertension
                  : "...",
              label: "Kasus Hipertensi",
            },
            {
              value:
                stats?.ptmCases?.diabetes !== undefined
                  ? stats.ptmCases.diabetes
                  : "...",
              label: "Kasus Diabetes",
            },
            {
              value: stats?.areaStats
                ? Object.keys(stats.areaStats).filter(
                    (k) => k !== "Lainnya" && stats.areaStats[k] > 0,
                  ).length
                : "...",
              label: "Dusun Terpantau",
            },
          ].map((stat, i) => (
            <div key={i} className="text-center">
              <div className="text-5xl font-serif text-brand-primary mb-2">
                {stat.value}
              </div>
      ...
      <footer className="bg-white pt-20 pb-10 px-8 border-t border-brand-light">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
          <div className="max-w-sm">
            ...
            <p className="text-slate-500 text-[14px] leading-relaxed">
              Menciptakan ruang hidup yang lebih sehat dengan pemantauan medis
              minimalis dan dampak lingkungan yang ramah, mewujudkan desa hijau
          ...
          <div className="grid grid-cols-2 gap-12">
            <div>
              <h4 className="text-[11px] font-bold uppercase tracking-widest text-brand-primary mb-6">
                Navigasi
              </h4>
            ...
            <div>
              ...
              <ul className="space-y-4 text-[14px] text-slate-500">
                ...
                <li>
                  <a
                    href="mailto:desa.caturharjo@bantulkab.go.id"
                    className="hover:text-brand-primary transition-colors"
                  >
                ...
                <li>
                  <a
                    href="https://wa.me/6289542884742"
                    target="_blank"
        ...
        <div className="max-w-7xl mx-auto pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-[12px] text-slate-400 font-medium">
          ...
          <div className="flex items-center gap-1">
            Dikembangkan oleh{" "}
            <HeartPulse className="w-3 h-3 text-brand-primary" /> PPK Ormawa IMM
            FKM 2026.
          </div>
        </div>
      </footer>
